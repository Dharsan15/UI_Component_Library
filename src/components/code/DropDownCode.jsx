    ...
    <div className="flex h-80 justify-center">
      <div className="relative inline-block">
        <button
          ...
          type="button"
          className="inline-flex gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-center text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-100 focus:ring focus:ring-gray-100 disabled:cursor-not-allowed disabled:border-gray-100 disabled:bg-gray-50 disabled:text-gray-400"
        >
          Options
          <svg
...
export default DropDownCloudCode;
