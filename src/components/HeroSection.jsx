        ...
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="flex lg:hidden">
            <button
              ...
              className="-m-2.5 inline-flex items- justify-center rounded-md p-2.5 text-gray-700"
            >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <Link to="/designtocode" className=" text-lg font-semibold leading-6 text-gray-900">
              {" "}
              Design to Code{" "}
            </Link>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-20 lg:py-32">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Enabling Developers to Build Products Faster
            </h1>
